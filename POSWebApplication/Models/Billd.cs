...
namespace POSWebApplication.Models
{
    public class Billd
    {
        ...
        [DisplayName("Spec Instr")][StringLength(100)] public string? SpecInstr { get; set; }
        ...
        [DisplayName("PrintedCount")] public short? PrintedCount { get; set; }
        ...
        [NotMapped] public string? Printer { get; set; }
        [NotMapped] public bool PrinterStatus { get; set; }
